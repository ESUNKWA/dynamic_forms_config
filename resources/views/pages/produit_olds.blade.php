                                ...
                                <form method="post" id="formProduits" enctype="multipart/form-data">
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <select class="form-select" aria-label="Default select example" name="r_type_client" id="r_type_client">
                                            <option selected>---Sélectionner le type de client---</option>
                                ...
                                <form method="post" id="formConvention" enctype="multipart/form-data">
                                    ...
                                    <div class="row mb-3">
                                        ...
                                        <div class="col">
                                            ...
                                            <input type="number" class="form-control" name="taux" id="taux" min="0" max="100">
                                        </div>
                                    </div>
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td class="text-muted">
                                        ...
                                        @case(1)
                                        <span class="badge rounded-pill text-bg-success">Actif
                                            &nbsp;<i class="fa fa-check"></i>
                                        </span>
                                        @break

                                        @default
                                        <span class="badge rounded-pill text-bg-danger">Inactif
