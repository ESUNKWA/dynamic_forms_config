...
<script>
    ...
    $(function(){
        ...
        $('#r_telephone').inputmask('09 99 99 99 99');
        let datas;
                ...
                <div class="modal-body">
                    ...
                    <form method="post" id="formProduits">
                        ...
                        <div class="row">
                            <div class="col">
                                <div class="mb-3">
                                    <label for="r_nom_entp" class="form-label is-required">Nom entreprise</label>
                        ...
                        <div class="row">
                            <div class="col">
                                <div class="mb-3">
                                    <label for="r_forme_juridique" class="form-label is-required">Forme jurique</label>
                        ...
                        <div class="row">
                            <div class="col">
                                <div class="mb-3">
                                    <label for="r_rccm" class="form-label is-required">N° du régistre de commerce</label>
                        ...
                        <div class="col">
                            <div class="mb-3">
                                <label for="r_email_entp" class="form-label is-required">Adresse email entreprise</label>
                        ...
                        <div class="row">
                            <div class="col">
                                <div class="mb-3">
                                    <label for="r_nom" class="form-label is-required">Nom du représentant</label>
                            ...
                            <div class="col">
                                <div class="mb-3">
                                    <label for="r_prenoms" class="form-label is-required">Prenoms Nom du représentant</label>
                        ...
                        <div class="row">
                            <div class="col">
                                <div class="mb-3">
                                    <label for="r_telephone" class="form-label is-required">Numéro de téléphone</label>
                            ...
                            <div class="col">
                                <div class="mb-3">
                                    <label for="r_email" class="form-label is-required">Adresse email</label>
