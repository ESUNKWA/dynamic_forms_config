...
@include('layouts.main.breadcrumb', [
  ...
  <div class="content">
    ...
    <!---------------------- Début Modal pour la saisie, la modification et la consultation des produits---------------------------------->
        ...
        <div class="row">
            <div class="col">
                <button type="button" class="btn btn-primary mb-2" id="newgrpe" title="Saisir un nouveau groupe de champs" style="float: right;" data-bs-toggle="modal" data-bs-target="#staticBackdrop">
                    Nouveau
                </button>
            </div>
        </div>
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <form method="post" id="formGrpeChamps">
                    ...
                    <div class="mb-3">
                        <label for="r_nom" class="form-label is-required">Nom du groupe</label>
