                ...
                let afficheFormsByProduct = (tabForms)=>{
                    ...
                    tabForms.forEach((item, index) => {
                        $("#formsProd").append(`<tr>
                            ...
                            <td class="fw-semibold">${(item.r_status == 0)? 'Inactif': 'Actif'}</td>
                                ...
                                tabChampsForms.forEach((item, index) => {
                                    ...
                                    if (item.champs.length >= 1) {
                                        ...
                                        $('body').on('click', '.addFormsFields', function () {
                                            ...
                                            console.log('obj',obj);
                                            console.log('formFieldsViews',formFieldsViews);
                                        ...
                                        $('body').on('click', '#restore', function () {
                                            ...
                                            Swal.fire({
                                                ...
                                                if (result.isConfirmed) {
                                                    ...
                                                    $.ajax({
                                                        type:"GET",
                                                        url: `{{ url('oba/formulaires/restoreall') }}`,
                                                        success: function(res){
                                ...
                                <div class="content">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col">
                                            ...
                                            <button class="btn btn-dark float-end m-1" id="btnListForm" title="Voir la liste des formulaires" hidden >Formulaires</button>
                                        </div>
                                    </div>
                                    ...
                                    <form action="#" class="form" id="forms" onsubmit="event.preventDefault()" hidden >
                                        ...
                                        <div class="step-forms step-forms-active">
                                            ...
                                            <div class="mt-5" >
                                                <button class="btn btn-next btn-primary width-50 ml-auto" id="btnNextInitial">Suivant&nbsp;<i class="fa fa-2x fa-arrow-right-long"></i></button>
                                            </div>
                                        </div>
                                        ...
                                        <div class="step-forms">
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-lg-9">
                                                    <div class="group-inputs">
                                                        <label for="r_nom" class="form-label">Nom du formulaire</label>
                                            ...
                                            <div class="btns-group mt-5">
                                                <button href="#" class="btn btn-prev btn-dark"><i class="fa fa-2x fa-arrow-left-long"></i>&nbsp;Précédent</button>
                                                <button href="#" class="btn btn-next btn-primary" id="btnNextOne">Suivant&nbsp;<i class="fa fa-2x fa-arrow-right-long"></i></button>
                                            </div>
                                        </div>
                                        ...
                                        <div class="step-forms">
                                            <div class="row mt-3">
                                                    ...
                                                    <div class="card">
                                                        <div class="card-body">
                                                            ...
                                                            <div class="row">
                                                                ...
                                                                <div class="col-sm-6">
                                                                    <label for="exampleFormControlInput1" class="form-label">Regroupement des champs</label>
                                                            ...
                                                            <h5 class="card-title ">Liste des champs</h5>
                                                ...
                                                <div class="col-sm-12 mt-3">
                                                    <div class="card">
                                                        <div class="card-body">
                                                            <h5 class="card-title">Champs du formulaire</h5>
                                            ...
                                            <div class="btns-group mt-5">
                                                <button href="#" class="btn btn-prev btn-dark"><i class="fa fa-2x fa-arrow-left-long"></i>&nbsp;Précédent</button>
                                                <button href="#" class="btn btn-next btn-primary" id="btnNextTwo">Suivant&nbsp;<i class="fa fa-2x fa-arrow-right-long"></i></button>
                                            </div>
                                        </div>
                                        ...
                                        <div class="step-forms">
                                            ...
                                            <div class="card">
                                                ...
                                                <div class="btns-group mt-5">
                                                    <a href="#" class="btn btn-prev btn-dark"><i class="fa fa-2x fa-arrow-left-long"></i>&nbsp; Précédent</a>
