    ...
    $(function(){
        ...
        $('#addTab').on('click', (e)=>{
            ...
            if( valid == true ){
                ...
                fields.forEach(item => {
                    $("#fields").append(`<tr>
                                            <td class="fw-semibold" hidden>${item.product}</td>
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <div class="row">
                    ...
                    <div class="col">
                        <label for="r_libelle" class="form-label is-required">Produits</label>
                    ...
                    <div class="col">
                        <label for="r_libelle" class="form-label is-required">Type de champs</label>
                ...
                <form method="post" id="formChamps">
                    ...
                    <div class="row mt-3">
                        ...
                        <div class="col">
                            <label for="field_label" class="form-label is-required">Libellé du champs</label>
