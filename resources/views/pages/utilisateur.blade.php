  ...
  <script>
    ...
    $(function(){
        ...
        $('body').on('click', '.edit', function () {
            ...
            $('#type_users').val(datas.r_canal_cnx);
                ...
                <div class="modal-body">
                    ...
                    <form method="post" id="formUtilisateur" enctype="multipart/form-data">
                        ...
                        <div class="row">
                            <div class="col">
                                <div class="mb-3">
                                    <label for="r_canal_cnx" class="form-label">Type utilisateur</label>
                            ...
                            <div class="col">
                                <div class="mb-3">
                                    <label for="user_role" class="form-label">Rôle utilisateur</label>
                            ...
                            <tr>
                                ...
                                <td class="text-muted">
                                    ...
                                    @switch($utilisateur->r_canal_cnx)
                                        ...
                                        @default
                                        <strong class="text-info" >Interface web admin</strong>
