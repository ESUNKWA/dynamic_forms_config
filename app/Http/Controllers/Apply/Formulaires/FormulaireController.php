        ...
        if ( !$inputsValidations->fails() ) {
            ...
            try {
                ...
                if( $checkForms->id ){
                    ...
                    $checkFields = Formulaire_champs::where('r_formulaire',$idForm)->delete();
                        ...
                        if( $checkFields ){
                            ...
                            foreach ($fields as $field) {
                                ...
                                Formulaire_champs::create([
                                    ...
                                    'r_champs' => $field->id,
                                    'r_grp_champs' => ( isset($field->grp_chp_id) )? $field->grp_chp_id : $field->r_grp_champs,
                                    'r_es_obligatoire' => ( isset($field->r_es_obligatoire) )? $field->r_es_obligatoire : $field->field_validation,
                                    'r_rang' => ( isset($field->field_rang) )? $field->field_rang : $field->r_rang,
                                    'r_status' => 1,
                                    'r_creer_par' => $userId
                                ]);
                            }
