...
{
    use SendResponses, cryptData, Logout, Generics, Utilisateurs;
    ...
    public function index()
    {
        try {
            ...
            $donneesCryptees = $this->crypt($this->responseSuccess('Liste des utilisateurs', $listeUtilisateurs));
    ...
    public function validateurs(){
        try{
            ...
            return $this->crypt($this->responseSuccess('Liste des validateurs',$validateurs));
        }catch(\Exception $e){
