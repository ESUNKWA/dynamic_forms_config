...
class Dash extends Controller
{
    ...
    */
    ...
    public function dashClientWeb(Request $request){
        ...
        try{
            ...
            $dashquery = DB::select("SELECT sc_workflows.f_dashboard_client_web(?)", [json_encode($inputs)])[0]->f_dashboard_client_web;
            $dash      = json_decode($dashquery);
            return  $this->crypt($dash);
